...
export async function GET() {
  const assessmentInfoRows = [
    ...
    ["الصف", "الثالث المتوسط"],
    ["الصفوف المستهدفة", "الثالث الابتدائي، السادس الابتدائي، الثالث المتوسط"],
    ["الشعبة", "أ"],
  ...
  const guideRows = [
    ...
    ["7", "تحليل نافس في بصيرة مخصص للصفوف المستهدفة: الثالث الابتدائي، السادس الابتدائي، الثالث المتوسط."],
  ];
